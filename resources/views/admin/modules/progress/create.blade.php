      ...
      <div class="row">
          <div class="col-md-12 col-sm-12">
              <div class="x_panel">
                  ...
                  <div class="x_content">
<form class="" action="{{route('progress.store') }}" method="post" >
@csrf 
...
<div class="field item form-group">
  ...
  <div class="field item form-group">
    ...
    <div class="col-md-6 col-sm-6">
    <input id="time_spent" type="text" class="form-control timepicker" name="time_spent" class='optional' required placeholder="Select time spent">
